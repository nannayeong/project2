...
<div id="top" style="border:0px solid #000;"> 
	...
	<ul id="lnb">
		...
		<li><a href="../member/join01.jsp"><img src="../images/lnb02.gif" alt="JOIN" /></a></li>
			...
			<c:otherwise>
		<!-- 로그인후 -->
		<li><a href="../main/main.do?logout=Y"><img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="321,0,420,33" href="../market/shopList.do" target="" />
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../board/boardList.do?boardName=notice" target="" />
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../board/boardList.do?boardName=staff" target="" />
