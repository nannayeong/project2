 ...
 <script>
 	function termCheck(){
 		if($("input:checkbox[name=agreement1]").is(":checked") == true) {
 			location.href="join02.jsp?agreement=Y";
 		}
 		else{
 			alert("약관에 동의해주세요");
 		}
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><a href="javascript:termCheck();"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
