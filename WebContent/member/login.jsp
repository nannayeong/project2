			...
			<div class="right_contents">
				<div class="top_title">
					...
					<div class="login_box01">
						...
						<form action="../main/main.do" id="frm" method="post" onsubmit="return loginFunc(this);">
						<ul>
							<li><img src="../images/login_tit001.gif" alt="아이디" style="margin-right:15px;" /><input type="text" name="id" value="${cookieId!=null?cookieId:''}" class="login_input01" /></li>
